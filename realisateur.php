<?php
    ...
    $RealDeCettePage = null;
    
    if(isset($_GET['realisateur'])){

        $getReal = htmlspecialchars($_GET['realisateur']);
        foreach($dataRealisateur as $row){
            if ($row['id_realisateur']==$getReal) {
                $RealDeCettePage = $row;
            }
        }

        if ($RealDeCettePage == null){
...
<!-- navbar -->
    ...
    <div class="container" id="real-div" data-aos="fade-right" data-aos-duration="500">
        <img id="real_photo" src="assets/img/real/<?php echo $RealDeCettePage['photo_realisateur']?>.jpeg" alt="">
        <div id="info-real">
            <h2><?php echo $RealDeCettePage['prenom_realisateur']. ' ' .$RealDeCettePage['nom_realisateur']?></h2>
            <h4>Info :</h4>
            <p>Age : <?php echo $RealDeCettePage['age_realisateur']?> ans</p>
            <p>Date de naissance : <?php echo $RealDeCettePage['naissance_realisateur'] ?></p>
            <p>Origine : <?php echo $RealDeCettePage['nationnalite_realisateur'] ?></p>
